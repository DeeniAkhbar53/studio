              ...
              <AccordionItem value={item.title} key={item.title} className="border-b-0">
                <Tooltip>
                    <TooltipTrigger asChild>
                        <AccordionTrigger className="rounded-lg border border-transparent px-3 py-2 text-sidebar-foreground transition-all hover:border-white/10 hover:bg-sidebar-accent/75 hover:text-sidebar-accent-foreground hover:no-underline data-[state=open]:border-white/10 data-[state=open]:bg-sidebar-accent/75 data-[state=open]:text-sidebar-accent-foreground">
                      ...
                      return (
                        <li key={subpage.href}>
                          <Link
                            href={subpage.href}
                            className={cn(
                              "flex items-center justify-between gap-3 rounded-md border border-transparent px-3 py-2 text-sidebar-foreground/90 transition-all hover:border-white/10 hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground",
                              isActive ? "border-sidebar-primary/40 bg-sidebar-primary text-sidebar-primary-foreground shadow-lg shadow-sidebar-primary/20 font-semibold" : ""
                            )}
                          >
